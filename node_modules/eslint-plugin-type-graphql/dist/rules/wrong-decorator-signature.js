...
exports.default = createRule_1.createRule({
    ...
    create(context, options) {
        ...
        return typeGraphQLUtil_1.getTypeGraphQLVisitors(checker, parserServices, ({ decoratorProps, decoratedProps }) => {
            ...
            const expected = typeGraphQLUtil_1.getExpectedTypeGraphQLSignatures(decoratedProps.type, getAllowedTypes(options, decoratedProps.type));
            ...
            if (!expected.typeFunctions.includes(found.typeFunction) &&
                ...
                context.report({
                    ...
                    data: {
                        expected: createDisjunction_1.createDisjunction(expected.typeFunctions),
