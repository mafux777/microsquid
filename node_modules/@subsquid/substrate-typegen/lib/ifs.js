...
class Interfaces {
    constructor(description) {
        ...
        this.nameAssignment = (0, names_1.assignNames)(description);
    ...
    makeType(ti) {
        ...
        switch (codecType.kind) {
            case substrate_metadata_1.TypeKind.Primitive:
                return (0, util_2.toNativePrimitive)(codecType.primitive);
            case substrate_metadata_1.TypeKind.Compact:
                return (0, util_2.toNativePrimitive)(codecType.integer);
            ...
            case substrate_metadata_1.TypeKind.Variant: {
                ...
                let result = (0, util_2.asResultType)(this.types[ti]);
                if (result) {
            ...
            case substrate_metadata_1.TypeKind.DoNotConstruct:
                return 'never';
            default:
                throw (0, util_1.unexpectedCase)(codecType.kind);
        }
    }
    makeTuple(fields) {
    ...
    printStructFields(out, fields) {
        fields.forEach(f => {
            let name = (0, util_1.toCamelCase)((0, util_1.assertNotNull)(f.name));
    ...
    getName(ti) {
        return (0, util_1.assertNotNull)(this.nameAssignment.get(ti));
    }
    isEmpty() {
