...
exports.upperCaseFirst = exports.groupBy = exports.toNativePrimitive = exports.asResultType = exports.isEmptyVariant = void 0;
...
function toNativePrimitive(primitive) {
    switch (primitive) {
        ...
        case "Str":
            return "string";
        default:
            throw (0, util_1.unexpectedCase)(primitive);
    }
}
