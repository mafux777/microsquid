...
class OldTypeRegistry {
    ...
    getTypes() {
        this.replaceAliases();
        return (0, util_2.normalizeMetadataTypes)(this.types);
    }
    replaceAliases() {
    ...
    normalizeNamedType(type, pallet) {
        if (pallet != null) {
            let section = (0, util_1.toCamelCase)(pallet);
    ...
    buildScaleType(type) {
        switch (type.kind) {
            ...
            default:
                throw (0, util_1.unexpectedCase)(type.kind);
        }
    }
    buildNamedType(type) {
    ...
    get(ti) {
        return (0, util_1.assertNotNull)(this.types[ti]);
    }
}
