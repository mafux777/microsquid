module.exports = class added_transfer1652247828199 {
  name = 'added_transfer1652247828199'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "token" character varying(4) NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "from_id" character varying NOT NULL, "to_id" character varying NOT NULL, "height_id" character varying NOT NULL, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
